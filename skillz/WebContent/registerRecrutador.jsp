...
<body>
    ...
    <h1 style="color: white;">Recrutador</h1>
        <form action="Authentication" method="post">
            <div class="form-group">
	            <div class="row">
	    			<div class="col-md-6">
	    				<input type="hidden"  id="tipo" name="tipo" value="recrutador">
	              ...
	              <div class="row">
	                ...
	                <div class="col-md-4">
		                ...
		                <div class="input-group">
		                    ...
		                    <input type="text" class="form-control" id="tefone" name="telefone" placeholder="Telefone" required>
		                </div>
	                </div>
